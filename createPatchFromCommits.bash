#!/bin/bash
#will create patch files for following commits.
...
#patch file will be outputed here.
outputDir='S:\patches'

count=0
for co in $commits ; do
	#git format-patch generate file names with ugly names, need convert to more readable.
